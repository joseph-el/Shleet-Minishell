...
#    Updated: 2023/02/05 16:34:49 by aelkhali         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME) 			:  	$(GC_MEMORY) $(LIBTOOLS) $(OBJS)
							@$(CC) $(FLAGS) $^ -o $@ -lreadline -L /Users/$(USER)/.brew/opt/readline/lib
...
.c.o		 		:	$(HEADERS)
							@$(CC) $(FLAGS) -c $< -o $@ -I $(INCLUDES) -I $(LIBTOOLS_PATH) -I $(addprefix $(GC_MEMORY_PATH), include) -I /Users/$(USER)/.brew/opt/readline/include
