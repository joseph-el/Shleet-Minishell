...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/01/31 11:05:27 by yoel-idr          #+#    #+#              #
#    Updated: 2023/01/31 14:30:09 by yoel-idr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ENV         := ./srcs/environment/environment.c ./srcs/builtins/shleet_exit.c srcs/environment/environment_utils1.c srcs/environment/environment_utils2.c ./srcs/environment/environment_utils3.c
...
EXC 		 := ./srcs/executor/ft_execve.c ./srcs/executor/executor_utils.c ./srcs/executor/executor.c ./srcs/utils/g_utils.c
